...
window.OrbitI18N = (function () {
  ...
  const D = {
    ...
    'rk.you': { pt: 'sua temporada', en: 'your season', es: 'tu temporada', fr: 'votre saison' },
    'rk.stElo': { pt: 'ELO', en: 'ELO', es: 'ELO', fr: 'ELO' },
    'rk.stPos': { pt: 'posição', en: 'rank', es: 'posición', fr: 'rang' },
    'rk.stRec': { pt: 'V · D', en: 'W · L', es: 'V · D', fr: 'V · D' },
    'rk.unplaced': { pt: 'sem jogos', en: 'no games', es: 'sin partidas', fr: 'aucun match' },
